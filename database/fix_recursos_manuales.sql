-- Permitir NULL en producto_recurso_id para recursos manuales
ALTER TABLE detalle_produccion MODIFY COLUMN producto_recurso_id INT(11) NULL;

-- Eliminar la restricción de clave foránea temporalmente
...
ADD CONSTRAINT detalle_produccion_ibfk_2 
FOREIGN KEY (producto_recurso_id) REFERENCES productos(id) 
