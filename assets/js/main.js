...
function countDown($days,$hour, $min, $sec, $deadLine) {
    ...
    function animateCounter(selector, targetValue) {
        ...
        if (!$element.length) return; // Verificar si el elemento existe
...
// Verificar si los elementos existen antes de iniciar el contador
if (document.querySelector('.days') && document.querySelector('.hours') && 
    document.querySelector('.minutes') && document.querySelector('.seconds')) {
    countDown(".days",".hours", ".minutes", ".seconds", "30 june 2025 00:00:00 GMT+6");
}

if (document.querySelector('.days_1') && document.querySelector('.hours_1') && 
    document.querySelector('.minutes_1') && document.querySelector('.seconds_1')) {
    countDown(".days_1",".hours_1", ".minutes_1", ".seconds_1", "30 dec 2024 00:00:00 GMT+6");
}
